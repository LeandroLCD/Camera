...
import com.leandrolcd.onvifcamera.OnvifCommands.profilesCommand
import com.leandrolcd.onvifcamera.OnvifCommands.servicesCommand
 ...
 */
class OnvifDevice internal constructor(
    ...
    private fun getEndpointForRequest(requestType: OnvifRequestType): String {
     ...
     companion object {
        ...
        suspend fun isReachableEndpoint(url: String): Boolean {
            try {
